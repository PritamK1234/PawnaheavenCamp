...
const OwnerProfile = () => {
  ...
  const TagList = ({
    ...
    type: "amenities" | "activities" | "highlights" | "policies";
    items: string[];
  }) => (
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-6">
        ...
        {/* Schedule Section */}
        <div className="space-y-3">
          <Label className="text-sm font-bold Capatalize tracking-widest text-gray-400 flex items-center gap-2">
          ...
          <div className="space-y-3">
            {(details.schedule || []).map((item, idx) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] font-bold text-[#D4AF37] Capatalize">
                      {item.time}
                    </p>
            ...
            <div className="p-4 border border-dashed border-[#D4AF37]/30 rounded-xl space-y-3 bg-[#1A1A1A]/50">
              <p className="text-[10px] font-bold text-gray-500 Capatalize tracking-widest">
                Add New Event
              </p>
